...
export function Popup() {
    ...
    return (
        ...
        >
            ...
            <TabsContent value={Tab.Runtime} className="mt-3 flex-1 overflow-y-auto">
                <Runtime />
            </TabsContent>

            <TabsContent value={Tab.Apps} className="mt-3 flex-1 overflow-hidden">
                <ComponentsList />
            </TabsContent>

            <TabsContent value={Tab.OrderForm} className="mt-3 flex-1 overflow-y-auto">
                <OrderForm />
            </TabsContent>
